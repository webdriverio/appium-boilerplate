...
Since we do not have Appium installed part of this package, this has been configured to use the global appium installation. This is configured in wdio.shared.conf.js
```
appium: {
        command : 'appium'
    },
